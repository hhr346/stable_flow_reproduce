...
from flux.sampling import denoise_layer, get_noise, get_schedule, prepare, unpack
from flux.util import embed_watermark, load_ae, load_clip, load_flow_model, load_t5

# 参数设定
MODEL_NAME = "flux-dev"
RESOLUTION = (500, 500)
OUTPUT_FOLDER = "output/layer"
...
class FluxGenerator:
    ...
    def generate_image(self, prompt, seed, init_image=None, img2img_strength=0.0):
        ...
        x_list = denoise_layer(self.model, **inp, timesteps=timesteps, guidance=opts.guidance)
        img_list = []
